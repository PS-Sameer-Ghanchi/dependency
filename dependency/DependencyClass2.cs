...
namespace dependency
{
    public class DependencyClass2
    {
        ...
        public DependencyClass2(OperationTransient AddTransient2, OperationScoped AddScope2, OperationSingleTone AddSingleTone2, OperationSingleToneInstance Instance)
        {
